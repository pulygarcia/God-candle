<template>
     <a href="https://www.linkedin.com/in/jose-ignacio-robledo/" class="hover:scale-110 transition" aria-label="Visitar">
        ...
        <a href="https://x.com/PulyGarciadev" class="hover:scale-110 transition" aria-label="Visitar">
        ...
        <a href="https://github.com/pulygarcia" class="hover:scale-110 transition" aria-label="Visitar">
        ...
        <a href="https://portfolio-v3-puly.netlify.app/" class="hover:scale-110 transition" aria-label="Visitar">
